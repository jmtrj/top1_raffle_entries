        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="POST" action="machines/function.php"  enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="row">
                          <div class="col-12">
                            <label for="User_Id" class="col-sm-12 control-label">Text</label>
                ...
                <div class="modal-body">
                    <div class="row">
                          <div class="col-12"><center>
                            ...
                            <input type="text" name="resets" hidden value="1">
                            </center>
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="POST" action="machines/function.php"  enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="row">
                          <div class="col-12">
                            <label for="User_Id" class="col-sm-12 control-label" >Upload files (.Xlsx Only)</label>
